...
namespace cvo {
  ...
  public:
    ...
    const Eigen::Matrix<float, Eigen::Dynamic, Eigen::Dynamic> & curvatures() const {return curvatures_;}
  ...
  private:
    ...
    Eigen::Matrix<float, Eigen::Dynamic, Eigen::Dynamic> curvatures_;  // surface normals
