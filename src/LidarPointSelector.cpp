...
namespace cvo
{
  ...
  void LidarPointSelector::legoloam_random_ground(pcl::PointCloud<pcl::PointXYZI>::Ptr pc_in,
                                                  pcl::PointCloud<pcl::PointXYZI>::Ptr pc_out,
                                                  std::vector <float> & edge_or_surface,
                                                  std::vector <int> & selected_indexes) {
    //using LeGO-LOAM's functions
    ...
    LeGoLoamPointSelection lego_loam;
    lego_loam.random_ground_removal(pc_in, pc_out, edge_or_surface, selected_indexes);
