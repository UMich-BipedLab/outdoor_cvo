...
#define EIGEN_DEFAULT_DENSE_INDEX_TYPE int
  ...
  static bool is_logging = true; // true;
  static bool debug_print = false; // false;
  ...
  int CvoGPU::align(const CvoPointCloud& source_points,
    ...
    std::ofstream function_angle_file("function_angle_history.txt");
    ...
    //for(int k=0; k<2; k++){
      ...
      if (is_logging) {
        ...
        function_angle_file<<function_angle(source_points, target_points, transform)<<"\n"<<std::flush;
